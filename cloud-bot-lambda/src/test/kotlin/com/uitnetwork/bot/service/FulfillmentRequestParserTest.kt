...
class FulfillmentRequestParserTest {

    private val fulfillmentRequestParser = FulfillmentRequestParser(ObjectMapperConfig().objectMapper())
    ...
    fun shouldParseSlackRequestCorrectly() {
        val fulfillmentRequest = fulfillmentRequestParser.parse(slackSampleRequest)
    ...
    fun shouldParseSlackRequestWithParamsCorrectly() {
        val fulfillmentRequest = fulfillmentRequestParser.parse(slackSampleRequestWithParams)
    ...
    fun shouldParseSkypeRequestCorrectly() {
        val fulfillmentRequest = fulfillmentRequestParser.parse(skypeSampleRequest)
