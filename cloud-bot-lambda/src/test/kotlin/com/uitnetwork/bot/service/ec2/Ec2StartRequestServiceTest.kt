...
class Ec2StartRequestServiceTest {
    companion object {
    ...
    @InjectMocks
    private lateinit var ec2StartRequestService: Ec2StartRequestService

    @Test
    fun shouldReturnEc2StartAction() {
        assertThat(ec2StartRequestService.getProcessableActionName()).isEqualTo(ACTION_EC2_START)
    }
    ...
    fun shouldStartEc2ByIdFirst() {
        ...
        val fulfillmentResponse = ec2StartRequestService.doProcess(fulfillmentRequest)

        assertThat(fulfillmentResponse.speech).isEqualTo("Starting EC2: $TEST_EC2_ID_1")
        assertThat(fulfillmentResponse.displayText).isEqualTo("Starting EC2: $TEST_EC2_ID_1")
        verify(ec2Service).startEc2Instance(TEST_EC2_ID_1)
    ...
    fun shouldStartEc2ByNameWhenThereIsNoId() {
        ...
        assertThat(fulfillmentResponse.speech).isEqualTo("Starting EC2: $TEST_EC2_ID_1, $TEST_EC2_ID_2")
        assertThat(fulfillmentResponse.displayText).isEqualTo("Starting EC2: $TEST_EC2_ID_1, $TEST_EC2_ID_2")
        verify(ec2Service).getEc2InstancesByInstanceName(TEST_EC2_NAME)
        verify(ec2Service).startEc2Instance(TEST_EC2_ID_1, TEST_EC2_ID_2)
        verifyNoMoreInteractions(ec2Service)
    }
